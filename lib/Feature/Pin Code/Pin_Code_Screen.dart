              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(text: "${widget.email}", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 15)),
                                ],
                        ...
                        Padding(
                          ...
                          child: Text(
                            hasError ? "*Merci de remplir toutes les cellules correctement svp" : "",
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () => snackBar("Renvoie de l'OTP!!"),
                              child: const Text(
                                "RENVOYER",
                        ...
                        FadeAnimation(
                          ...
                          child: TextButton(
                              onPressed: () {
                                ...
                                if (currentText.length != 6 || widget.id.padLeft(6, "0") != currentText) {
                                  ...
                                  setState(
                                    () {
                                      hasError = false;
                                      snackBar("Authentification réussi !!");
                ...
                FadeAnimation(
                  ...
                  child: Row(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text("Vous voulez réessayer? ",
                          style: TextStyle(
                            color: Colors.grey,
                            letterSpacing: 0.5,
                          )),
                      GestureDetector(
                        ...
                        child: Text("Connexion", style: TextStyle(color: Colors.white.withOpacity(0.9), fontWeight: FontWeight.bold, letterSpacing: 0.5, fontSize: 14)),
                      ),
                    ],
                  ),
                ),
